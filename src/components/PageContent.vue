      ...
      <div class="left fl">
        ...
        <div class="main">
          <div class="focusBox2">
            ...
            <ul class="num">
              <li v-for="index in 6" :key="index"><a></a><span></span></li>
            </ul>
          </div>
          <div class="news">
            <div class="sec_title">
          ...
          <div class="news_list">
            <ul>
              <!-- <li v-for="(item,index) in tzgg" :key="index" v-if="index > 0 && index < 7">&gt;<a :href="`/index/catetory/${item.catetoryId}/article/${item.articleId}`">{{item.title}}</a><span>[{{item.publicTime | normalTime}}]</span></li> -->
              <li v-for="(item, index) in tzggs" :key="index">
                &gt;<a
                  :href="
                    `/index/catetory/${item.catetoryId}/article/${
                      item.articleId
                    }`
                  "
                  >{{ item.title }}</a
          ...
          <div class="login-form container">
            <form action="login" name="loginForm" id="loginForm" role="form">
              ...
              <div class="buttons fl">
                <button class="login fl" type="submit">
                  <span class="loginfor7">登 录</span
                  ><span class="arrow fr"
                    ><img src="/static/img/login_icon.png"
                  /></span>
                </button>
                <button class="prologin">
                  专家登录<span class="arrow fr"
                    ><img src="/static/img/login_icon.png"
                  /></span>
                </button>
              </div>
    ...
    <div class="contentC container">
      <div class="left fl">
        ...
        <div class="main">
          ...
          <div class="txt fr">
            <p>
              首都经济贸易大学（Capital University of Economics and
              Business）简称“首都经贸”，坐
              落于中国北京，是一所拥有经济学、管理学、法学、文学、理学和工学等六大学科，以经济学
              、管理学为重要特色和突出优势的财经类大学。
    ...
    <div class="contentE container">
      ...
      <div class="main">
        <div class="cop cop1">
          ...
          <span class="pic_tit"><a href="">首都经济贸易大学1</a></span>
        </div>
        <div class="cop cop2">
          <img src="/static/img/cop.png" />
          <span class="pic_tit"><a href="">首都经济贸易大学2</a></span>
        </div>
        <div class="cop cop3">
          <img src="/static/img/cop.png" />
          <span class="pic_tit"><a href="">首都经济贸易大学3</a></span>
        </div>
        <div class="cop cop4">
          <img src="/static/img/cop.png" />
          <span class="pic_tit"><a href="">首都经济贸易大学4</a></span>
        </div>
        <div class="cop cop5">
          <img src="/static/img/cop.png" />
          <span class="pic_tit"><a href="">首都经济贸易大学5</a></span>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    tzggs: function() {
      return this.tzgg.filter(function(item, index) {
...
.ladyScroll span {
  ...
  opacity: 0.7;
  border-radius: 8px; /* transition:bottom 0.2s ease-in-out;-moz-transition:bottom 0.2s ease-in-out; Firefox 4-webkit-transition:bottom 0.2s ease-in-out; Safari and Chrome-o-transition:bottom 0.2s ease-in-out; Opera */
}
.ladyScroll dt {
  width: 260px;
  overflow: hidden;
...
.ladyScroll dd {
  ...
  position: absolute;
  bottom: -45px;
  text-align: center; /* transition:bottom 0.2s ease-in-out;-moz-transition:bottom 0.2s ease-in-out; Firefox 4-webkit-transition:bottom 0.2s ease-in-out; Safari and Chrome-o-transition:bottom 0.2s ease-in-out; Opera */
}
.ladyScroll dd a {
  color: #fff;
}
